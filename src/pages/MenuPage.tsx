    ...
    <div className="page-container relative">
      <div className="px-6 pt-14 pb-5 border-b border-white/10 shrink-0">
        ...
        <p className="text-xs text-jin-muted mt-1">
          {dishes?.length} recipes reviewed
        </p>
      </div>
      ...
      <div className="px-4 pt-4 shrink-0">
        <div className="flex items-center gap-3 bg-jin-ink-2 border border-white/10 rounded-2xl px-4 py-3">
          <svg
            className="w-4 h-4 stroke-jin-muted shrink-0"
            viewBox="0 0 24 24"
            fill="none"
            strokeWidth={1.8}
            strokeLinecap="round"
      ...
      <div className="flex gap-2 px-4 py-3 overflow-x-auto scroll-hide shrink-0">
        <button
      ...
      <div className="scroll-area">
        ...
        {filtered.map((dish, i) => (
          <div
            key={dish.id}
            className="flex items-center gap-4 px-4 py-4 border-b border-white/6"
          >
            <span className="font-display text-base text-jin-muted w-5 text-center shrink-0">
              {i + 1}
            </span>
            <div className="w-12 h-12 rounded-xl bg-jin-ink-2 flex items-center justify-center shrink-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[11px] text-jin-muted mt-0.5">
                {dish.category ?? '—'}
              </p>
            </div>
